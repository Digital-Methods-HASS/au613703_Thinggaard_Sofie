...
date: "01/03/2022 updated `r Sys.Date()`"
output:
...
plot(mounds$elev) #changing Adela's script
hist(mounds$elev)
```
...
#Do the same with prominence raster and mounds.
plot(prominence)
plot(st_geometry(mounds), add = TRUE)
