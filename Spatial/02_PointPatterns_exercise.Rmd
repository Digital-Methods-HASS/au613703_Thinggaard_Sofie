...
```{r, eval= TRUE}
#data: `ppp` object
redoak <- readRDS("data/redoak.rds") #locations of trees
```
...
* I can reject the null hypothesis with p-value less than 0.01 #correct. The p-value= 4.477e-07

### Hint: check out the measure from the first exercise 
```{r Tree location pattern}
# Plotting the tree locations
plot(redoak)

#repeat task 1 and 2

# Calc nearest-neighbor distances
